...
echo "[STRONG WARNING] This process removes all Containers in the dbgr-network, which means your running Apps will be stopped."
...
for container_id in "${container_ids[@]}"; do
    echo "[NOTICE] Stopping & Removing containers for removing the dbgr network : $container_id"
