...
public class ResourceAuthFailureHandler implements AuthenticationEntryPoint, AccessDeniedHandler {
    ...
    public void commence(HttpServletRequest request, HttpServletResponse response, AuthenticationException e) throws IOException, ServletException {
        ...
        // oauth_removed_access_token 의 가비지 값이 발생 한다면 Spring Security 의 남은 Access Token 유효 기간 (oauth2.samplewave.front.accessTokenValiditySeconds) 에 created_at 컬럼을 더한 값들을 주기적으로 지워줄 필요가 있다.
        ...
        if (authorization != null && authorization.contains("Bearer")) {
            ...
            if(oauthRemovedAccessToken != null){
                ...
                // Samplewave-Front 에서 모든 페이지들이 다음 API를 호출한다.
