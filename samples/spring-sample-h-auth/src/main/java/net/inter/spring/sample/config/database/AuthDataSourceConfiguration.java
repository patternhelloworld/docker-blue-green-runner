...
@Configuration
@MapperScan(basePackages = {"net.inter.spring.sample.mapper.auth"}, sqlSessionFactoryRef = "authSqlSessionFactory")
@EnableJpaRepositories(
        basePackages = {"net.inter.spring.sample.microservice.auth", "net.inter.spring.sample.config.security"},
...
public class AuthDataSourceConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean authEntityManagerFactory(EntityManagerFactoryBuilder builder) {
        return builder
                ...
                .packages("net.inter.spring.sample.microservice.auth", "net.inter.spring.sample.config.security")
