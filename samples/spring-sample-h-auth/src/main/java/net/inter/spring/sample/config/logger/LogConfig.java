...
/*
 *  Spring security 관련 API(ex. 로그인)은 로그를 남기지 않는다.
 * */
@Aspect
@Component
public class LogConfig {
    ...
    // 표현식 설명 : net.inter.spring.sample.controller 패키지 및 하위 패키지(..)의 모든 메서드(*)
    @AfterReturning(pointcut = ("within(net.inter.spring.sample.controller..*)"),
    ...
    @AfterReturning(pointcut = ("within(net.inter.spring.sample.exception.handler..*)"),
            returning = "returnValue")
