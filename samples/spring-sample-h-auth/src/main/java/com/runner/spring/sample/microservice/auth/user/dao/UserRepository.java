...
public interface UserRepository extends JpaRepository<User, Long>, QuerydslPredicateExecutor<User> {
    ...
    @Modifying
    @Query(value = "UPDATE spring_sample_h_auth.users users SET users.active = :active " +
    ...
    @Modifying
    @Query(value = " UPDATE spring_sample_h_auth.users users " +
            " INNER JOIN spring_sample_h_auth.user_role userRole" +
